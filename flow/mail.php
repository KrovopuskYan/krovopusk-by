...
$email = 'flower.studio2017@yandex.ru'; // адрес куда отправлять письмо, можно несколько через запятую
...
$addreply = 'krovopusk.yan@gmail.com'; // адрес куда отвечать (необязательно)
$from = 'Flowerstudio.by'; // имя отправителя (необязательно)
...
$username = 'flower.studio2017@yandex.ru'; // логин вашего почтового ящика
$password = 'VLKnqq88OT'; // пароль вашего почтового ящика
